<#
===============================================================================
 ABSEGA | PsExec service execution (T1569.002) FORMAL VALIDATION RECORDER
===============================================================================
...
$TestId           = "AD-T1569.002-PSEXEC"
$SigmaDetectionId = 293
$BehaviorLabel    = "PsExec service execution"
$Technique        = "T1569.002"
$ExpectedEventIds = @("7045","4697","4624","5145","1")
$SourceHost       = "WIN11"
