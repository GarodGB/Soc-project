<#
===============================================================================
 ABSEGA | LDAP password spray (T1110.003) FORMAL VALIDATION RECORDER
===============================================================================
...
$TestId           = "AD-T1110.003-LDAP-SPRAY"
$SigmaDetectionId = 179
$BehaviorLabel    = "LDAP password spray"
$Technique        = "T1110.003"
$ExpectedEventIds = @("4625","4771","4776")
$SourceHost       = "WIN11"
